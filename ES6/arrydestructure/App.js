...
/*Traditional way to extract values from array instead of this we can use array destructuring */
// let arr=[1,2,3];
// const a=arr[0];
// const b=arr[1];
// const c=arr[2];
...
[fiveStarRatingCount,oneStarRatingCount,threeStarRatings=0]=ratingStars;
